...
"************* comment about each term*******************"
1. time" " 2. temp0_target" "3. temp_real" " 4. etot" "5. ktot" "6. ptot" "7. sel" "8. lel" "9. snb" " 10. vdw" "11. egb" "12. rest" "13. repn  14. frame 15 ca-rmsd 16. frame 17. BB rmsd 18 frame. 19 noH rmsd 20 replica # 21. frame 22. wrong.temperature 23 atomic contact 24 residue contact  // in "energy" file and "all" file
...
1. time 2. temp0_target   3. temp_real    4. etot   5. ktot   6. ptot   7. sel   8. lel   9. snb    10. vdw   11. egb   12. rest   13. repn 14. ca-rmsd 15. BB rmsd 16. noH rmsd 17. replica # 18. atomic contact 19. residue contact  // in "energy" file and "s_all" file
...
for temp in `cat ../temperatures.dat`; do temp7=`printf "%.4f" $temp`;temp07=`printf "%08.4f" $temp`;echo $temp7" "$temp07 ;grep -h "000 $temp7" remd12.s_all.* > remd12.temp.$temp07;done

"************* UP-DATE: comment about each term*******************"
1. time 2. temp0_target   3. temp_real    4. etot   5. ktot   6. ptot   7. sel   8. lel   9. snb    10. vdw   11. egb   12. rest   13. repn 14. ca-rmsd 15. BB rmsd 16. noH rmsd 17. replica # 18. atomic contact 19. residue contact  // in "energy" file and "temp.xxx.xxxx" file, xxx.xxxx is formated number for temperature.
